    ...
    return AlertDialog(
            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  maxLines: 3,
                  decoration: const InputDecoration(
                    hintText: 'Enter what was discussed, promised, or resolved...',
                    border: OutlineInputBorder(),
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Row(
                          children: [
                            const Icon(Icons.calendar_month, size: 18, color: Color(0xFF059669)),
      ...
      actions: [
        ...
        FilledButton.icon(
          ...
          label: const Text('Save & Finish Follow-up'),
        ),
      ],
    );
  }
