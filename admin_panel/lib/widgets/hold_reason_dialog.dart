            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: const Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'Customer will be removed from Active Action Center queues. Customer can be reopened anytime.',
                ...
                if (isOther) ...[
                  ...
                  TextFormField(
                    ...
                    decoration: const InputDecoration(
                      ...
                      hintText: 'Enter specific hold reason...',
                      border: OutlineInputBorder(),
                      contentPadding: EdgeInsets.symmetric(horizontal: 12, vertical: 10),
                    ),
                    validator: (val) {
                ...
                TextFormField(
                  ...
                  maxLines: 2,
                  decoration: const InputDecoration(
                    hintText: 'Additional notes regarding the hold...',
                    border: OutlineInputBorder(),
