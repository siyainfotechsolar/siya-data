...
class ExportDefinitions {
  ...
  static final List<ExcelColumnDef<ConsumerRecord>> consumerRecordColumns = [
    ...
    ExcelColumnDef<ConsumerRecord>(header: 'Site Type', valueExtractor: (r) => r.siteType),
    ExcelColumnDef<ConsumerRecord>(header: 'System Capacity', valueExtractor: (r) => r.systemCapacity),
    ExcelColumnDef<ConsumerRecord>(header: 'System Type', valueExtractor: (r) => r.systemType),
    ExcelColumnDef<ConsumerRecord>(header: 'Subsidy Status', valueExtractor: (r) => r.isNonSubsidy ? 'N/A (Non-Subsidy)' : r.subsidyStatus),
  ...
  static final List<ExcelColumnDef<LeadRecord>> leadRecordColumns = [
    ...
    ExcelColumnDef<LeadRecord>(header: 'Site Type', valueExtractor: (l) => l.siteType),
